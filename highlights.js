AFRAME.registerComponent("cursor-listener", {
  ...
  init: function () {
    //TASK 🙂
    // call the handleMouseEnterEvents() and handleMouseLeaveEvents() function here
    handleMouseEnterEvents.handleMouseClickEvents()
    handleMouseLeaveEvents.handleMouseLeaveEvents()
  ...
  update: function () {
    ...
    if (c.length > 0) {
      ...
      ////TASK 🙂
      // Call the handleMouseClickEvents() function here as this.handleMouseClickEvents();
  ...
  handleMouseEnterEvents: function () {
    ...
    this.el.addEventListener("mouseenter", () => {
      ...
      if (postersId.includes(id)) {
        ...
        ////TASK 🙂
        // give colorcode this -> #1565c0 to the element in next statement here
  ...
  handleMouseClickEvents: function () {
    ...
    this.el.addEventListener("click", () => {
      ...
      if (selectedItemId) {
        ...
        //TASK 🙂
        //make the plane invisible and titleEl visible here (Look at lines 81 and 85 for help)
